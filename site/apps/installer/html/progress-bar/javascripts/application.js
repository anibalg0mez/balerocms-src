...
(function() {
  ...
  window.App = {
    sections: ['tables', 'data', 'system', 'congrats'],
    progressBar: null,
    init: function() {
      var self;
      self = this;
      ...
      this.progressBar.removeClass("transition").addClass("transition");
      ...
      return $(".ui-progress", this.progressBar).animateProgress(35, function() {
        ...
        return setTimeout((function() {
          $("#progress_bar").removeClass("error");
          return $("#progress_bar .ui-progress").animateProgress(60, function() {
            self.fadeInNextSection();
            $("#progress_bar");
            return setTimeout((function() {
				          return $("#progress_bar .ui-progress").animateProgress(90, function() {
            self.fadeInNextSection();
