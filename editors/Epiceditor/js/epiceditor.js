  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        ...
        , theme: { base: myURL+'editors/Epiceditor/themes/base/epiceditor.css'
          , preview: myURL+'editors/Epiceditor/themes/preview/github.css'
          , editor: myURL+'editors/Epiceditor/themes/editor/epic-dark.css'
          }
    /**
     *
     * End Balero CMS integaration.
     *
     **/
        , focusOnLoad: false
